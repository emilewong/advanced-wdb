...
const myCar = new Car('someMake', 'someModel', 2010);
console.log(JSON.stringify(myCar, null, 4) + '\n')

const myMoto = new Motorcycle('someMake', 'someModel', 2010);
console.log(JSON.stringify(myMoto, null, 4) + '\n')
myMoto.toString()