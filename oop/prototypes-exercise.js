...
//Testing
var nicole = new Person('Nicole', 'Sattler', 'Gray', 11);
var person1 = new Person('Jane', 'Doe', 'Black', 42);
  // var person2 = new Person('Billy', 'Bob', 'Red', 77);

  // person1.addToFamily(person2);

  // nicole.addToFamily(person1);
  // nicole.addToFamily(person1);

  // nicole.addToFamily(person2);
